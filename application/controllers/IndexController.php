...
class IndexController extends Alcotec_Frontend_Controller_IndexController {
	...
	public function indexAction() {
        ...
        $this->view->footer_articles = $modArticles->fetchAll("visible = 1", 'date DESC');
//        $this->view->footer_articles = $modArticles->fetchAll("site_id = {$siteId} and visible = 1", 'date DESC');
