                ...
                <div class="filter-group price_filter">
                    <ul>
                        ...
                        <li>
                            ...
                            <input placeholder="От" class="price_field price_filter_start" type="text" id="price_from"
                                   {if $zf.params.price_from}value="{$zf.params.price_from}"{/if}/>
                            <input placeholder="до" class="price_field price_filter_end" type="text"
                                   {if $zf.params.price_to}value="{$zf.params.price_to}"{/if} id="price_to"/>
                        ...
                        {foreach from=$filters item=filters key=type}
                                    ...
                                    <div class="filter-group">
                                        <ul>
                                            ...
                                            {foreach from=$filter.values item=value}
                                                {if $value.possible}
                                                    <li class="fg-item">
                                                        <a {if $value.selected}class="active"{/if}
                                                           href="{url2 $filter.urlhelperarg=$value.add param=$route}">
                                                            {$value.value}
                                                        </a>
                                                    </li>
                                                {else}
                                        ...
                                        {if $filter.accepted}
                                            <a href="{url2 $filter.urlhelperarg=null param=$route}"
                                               class="btn btn-mini">
                                                Сбросить фильтр
                                            </a>
                                        {/if}
                                ...
                                {foreach from=$filters item=filter}
                                    <div class="filter-group">
                                        <ul>
                                            <li>
                                                <span class='title'>
                                                    <label for="amount_{$filter.id}">
                                                        {$filter.name}{if $filter.measure} ,{$filter.measure}{/if}:
                                                    </label>
                                                    <input id="amount_{$filter.id}" type="hidden"/>
                                                </span>
                                            </li>
                                            <li>
                                                От
                                                ...
                                                <input class="btn btn-mini" id="submit_{$filter.id}" type="submit"
                                                       value="Ок"/>
                                            </li>
                                            <li>
                                                <div id="slider_{$filter.id}"></div>
                                            </li>
                                        </ul>
                                        {literal}
                            ...
                            {elseif $type == 'brands' && ($filters|@count > 1)}
                                <div class="filter-group">
                                            ...
                                            {if $brand.possible}
                                                <li class="fg-item">
                                                    <a {if $brand.selected}class="active"{/if}
                                                       href="{url2 assoc.brand=$brand.add assoc.page=null param=$route}">
                                                        {$brand.name}
                                                    </a>
                                                </li>
                                            {else}
                                    ...
                                    {if $zf.params.brand}
                                        <a href="{url2 assoc.brand=null param=$route}" class="btn btn-mini">
                                            Сбросить фильтр
                                        </a>
                                    {/if}
                                </div>
