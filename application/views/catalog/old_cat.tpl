...
<div class="h1_holder span-12 no_margin 123123">
    <h1>
        ...
        {/if}
        {if $accepted_filters}
        {foreach from=$accepted_filters item=filter name=filters}{if $filter.name=='Материал'}из {$filter.name}а:
        "{else}, {$filter.name} - {/if}{foreach from=$filter.values item=filterValue
        name=filter_values}{$filterValue}{if !$smarty.foreach.filter_values.last}, {/if}{if
        $smarty.foreach.filters.first && $smarty.foreach.filter_values.last &&
        $filter.name=='Материал'}"{/if}{/foreach}{/foreach}
        {/if}
...
<div id="category_block_view_listing" class="span-12 no_margin">
    ...
    <div class="span-4 category_block_view_item">
        ...
        <span {if $item.acttype=='gift'}id="refund_electrolux_gift"{else}id="refund_electrolux"{/if}
              data-title="{$temporary_cashback_setting_action.catalog_label_for_what}" style="display: block;
    text-align: center;
    color: #f9ebf3;
    font-size: 16px;
    font-weight: bold;
    ...
    {if $catId == '12' || $catId == '13' || $catId == '15' || $catId == '18' || $catId == '21' || $catId == '24' ||
    $catId == '25' || $catId == '28' || $catId == '29' || $catId == '37' || $catId == '45' || $catId == '46' || $catId
    == '48' || $catId == '49' || $catId == '50' || $catId == '66' || $catId == '68' || $catId == '78' || $catId == '92'
    || $catId == '94' || $catId == '141' || $catId == '145' || $catId == '169' || $catId == '178' || $catId == '210' ||
    $catId == '211' || $catId == '212' || $catId == '213' || $catId == '270' || $catId == '274' || $catId == '308'}

    <div class="span-4 category_block_view_item">
        {if $catId =='12'}<a
                href="https://590.ua/catalog/action/ids/14903,20686,20713,21960,23460,25910,27331,27288,19433,19434,19472,19474,19476,19477,19478,19525,22151,22152,27827,27828,27829,20737,27312,15302,15353,16077,21219,25597,23659">{elseif
            $catId =='13'}<a href="https://590.ua/catalog/action/ids/19995,21126,23440,23441,19891">{elseif $catId
                =='15'}<a href="https://590.ua/catalog/action/ids/21214,21215">{elseif $catId =='18'}<a
                            href="https://590.ua/catalog/action/ids/25304,26465,28405,28408,28515,28345,28354,28422,24776">{elseif
                        $catId =='21'}<a
                                href="https://590.ua/catalog/action/ids/21580,24575,20446,21757,23046,24959,25103,25104,25377">{elseif
                            $catId =='24' || $catId =='213'}<a
                                    href="https://590.ua/catalog/action/ids/23129,24519,26258,26264,26372,21149,24695,24697,26147,25377">{elseif
                                $catId =='25'}<a href="https://590.ua/catalog/action/ids/25992,13723,20655,20668,20742">{elseif
                                    $catId =='28'}<a
                                            href="https://590.ua/catalog/action/ids/881,882,1014,1015,1031,1042,1043,12193,12652,13913,15147,17166,21522,24422,24426,24430,24742">{elseif
                                        $catId =='29'}<a
                                                href="https://590.ua/catalog/action/ids/1577,6519,6725,14608,14609,14612,14615,14616,16286,18023,18025,18035,22853,22882,23107">{elseif
                                            $catId =='37'}<a href="https://590.ua/catalog/action/ids/26178">{elseif
                                                $catId =='45'}<a
                                                        href="https://590.ua/catalog/action/ids/23403,25823,28461,28470,28471">{elseif
                                                    $catId =='46'}<a href="https://590.ua/catalog/action/ids/19820">{elseif
                                                        $catId =='48'}<a
                                                                href="https://590.ua/catalog/action/ids/21619,14492">{elseif
                                                            $catId =='49'}<a
                                                                    href="https://590.ua/catalog/action/ids/21671,23470,23957,26377,27964,23194,25187,25890,25983,25984">{elseif
                                                                $catId =='50'}<a
                                                                        href="https://590.ua/catalog/action/ids/27921">{elseif
                                                                    $catId =='66'}<a
                                                                            href="https://590.ua/catalog/action/ids/14734,19674">{elseif
                                                                        $catId =='68'}<a
                                                                                href="https://590.ua/catalog/action/ids/25236,21654">{elseif
                                                                            $catId =='78'}<a
                                                                                    href="https://590.ua/catalog/action/ids/25898">{elseif
                                                                                $catId =='92'}<a
                                                                                        href="https://590.ua/catalog/action/ids/8859">{elseif
                                                                                    $catId =='94'}<a
                                                                                            href="https://590.ua/catalog/action/ids/16322,23426">{elseif
                                                                                        $catId =='145' || $catId
                                                                                        =='141'}<a
                                                                                                href="https://590.ua/catalog/action/ids/26313,22634,24827">{elseif
                                                                                            $catId =='169'}<a
                                                                                                    href="https://590.ua/catalog/action/ids/24827">{elseif
                                                                                                $catId =='178'}<a
                                                                                                        href="https://590.ua/catalog/action/ids/27797">{elseif
                                                                                                    $catId =='210'}<a
                                                                                                            href="https://590.ua/catalog/action/ids/23318,22806,17498,21411,25226">{elseif
                                                                                                        $catId =='270'
                                                                                                        || $catId
                                                                                                        =='211'}<a
                                                                                                                href="https://590.ua/catalog/action/ids/18769,23145,23146,20837,22124,27107,27625,28110,28349,23066,23067,23141,23824,23827,24329,6742,8681">{elseif
                                                                                                            $catId
                                                                                                            =='212'}<a
                                                                                                                    href="https://590.ua/catalog/action/ids/26664,16057,16368,24794,25167,23166,23393,25903,27878,21465,23329">{elseif
                                                                                                                $catId
                                                                                                                =='274'}<a
                                                                                                                        href="https://590.ua/catalog/action/ids/24706">{elseif
                                                                                                                    $catId
                                                                                                                    =='308'}<a
                                                                                                                            href="https://590.ua/catalog/action/ids/28485">{else}<a
                                                                                                                                href="#">{/if}
    ...
    width: 90px;">{$temporary_cashback_setting_action.catalog_label_info} {$temporary_cashback_summ[$iteration_action]} грн</span>
            ...
            {if $smarty.foreach.catitems.iteration <= 4 && $smarty.foreach.catitems.iteration <=
            $smarty.foreach.catitems.total}
            <div style="display:none"><!--cartdname-->{if $item.cat_onename}{$item.cat_onename}{else}{$item.cat}{/if}
                {$item.brand} {$item.name}<!--/cartdname--></div>
            {/if}
    ...
    margin-top: {$margin_top_icon}px;">
                    ...
                    <div onmouseover="hide_icons_bonus({$number_of_element})"
                         onmouseout="show_icons_bonus({$number_of_element})" class="bonus_on_card_{$number_of_element}">
                        <img src="/images/hint/piggy-bank.png"
                             style="position: absolute;margin-left: -29px;margin-top: 1px;">вернем<br><span
                                style="color: rgba(255, 39, 2, 0.81);font-weight: bold;font-size: 10px;font-style: italic;">{$item.bonus_amount|round} грн.</span>
                    ...
                    <div onmouseover="hide_icons_oplata_rassrochka({$number_of_element})"
                        ...
                        <div class="overlay_icons" style="margin-top: -30px;margin-left: -145px;font-style: italic;">
                            <div class="wrapper_body">
                                <div class="cbm_wrap ">
                                    <noindex><a href="https://chast.privatbank.ua/" rel="nofollow" target="_blank"><h1
                                                    title="Узнать подробнее...">МГНОВЕННАЯ РАССРОЧКА</h1></a></noindex>
                                    <noindex><a href="https://chast.privatbank.ua/" rel="nofollow" target="_blank"><img
                                                    title="Узнать подробнее..."
                                                    src="/images/hint/oplata_rassrochka.jpg"></a></noindex>
                    ...
                    <div class="overlay_icons" style="margin-top: -460px;margin-left: -201px;font-style: italic;">
                        <div class="wrapper_body">
                            <div class="cbm_wrap ">
                                ...
                                <noindex><a href="https://590.ua/articles/zamena" rel="nofollow" target="_blank"><img
                                                title="Узнать подробнее..." src="/images/hint/tradein_description.jpg"></a>
                                </noindex>
                                <p>Вы имеете следующую выгоду:<br>1. Весомая скидка на технику<br>2. Бесплатная доставка
                                    в квартиру<br>3. Бесплатное подключение<br>4. Вывоз и утилизация старой
...
">{$summ_temporary_celebration[$iteration_celebration]} грн.
                    ...
                    <div class="overlay_icons" style="margin-top: -475px;margin-left: -128px;font-style: italic;">
                        <div class="wrapper_body">
                            <div class="cbm_wrap ">
                                <noindex><a href="https://goo.gl/4CLd9k" rel="nofollow" target="_blank"
                                            title="Показать все товары со скидками"><h1>Christmas</h1></a></noindex>
                                <noindex><a href="https://goo.gl/4CLd9k" rel="nofollow" target="_blank"
                                            title="Показать все товары со скидками"><img
                                                src="/images/hint/black_friday.jpg"></a></noindex>
                                <p>Рождество - это тихий, семейный праздник, который стоит провести в кругу самых
                                    близких людей! Мы поздравляем всех наших клиентов с этим светлым праздником и дарим
                                    в честь него подборку товаров с большими скидками.<br><strong
                                            style="font-size: 11px; line-height: 11px;">Внимание: в акции не участвуют
                                        комплекты вместе дешевле. Акционные товары возможно оплатить: наличными, картой,
                                        безналичным переводом. Оплата частями от Приват Банка не распространяется на
                                        акционные товары.</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {if $catId == 26 || $catId == 25 || $catId == 209 || $catId == 102 || $catId == 18 || $catId == 24 ||
                $catId == 212 || $catId == 37 || $catId == 314 || $catId == 21 || $catId == 36 || $catId == 322 ||
                $catId == 12 || $catId == 16 || $catId == 88 || $catId == 210 || $catId == 211 || $catId == 175 ||
                $catId == 10 || $catId == 15 || $catId == 155 || $catId == 39 || $catId == 213 || $catId == 11 || $catId
                == 13 || $catId == 34 || $catId == 302 || $catId == 67}
                {if $item.acttype !== 'gift' && $item.x_index == '1' || $item.id == '21465'}
    ...
    margin-right: 40%;" class="price_sidebar priceForEcommerce">{price $item.price $item.id_currency}
                ...
                <p>{$item.qrm}, {$item.qty_z}
                    , {if $item.rqrm}{$item.rqrm}{else}-{/if}{if $login == 'Сергей Гринюк' || $login == 'Vadyus' ||
                    $login == 'Vitaliy Shyshko'}{if $item.rent},({$item.rent|round}){/if},[{$item.sold}]{/if}</p>
                {/if}
                {literal}
                <style type="text/css">
                    .btn:hover {
    ...
    text-align: center;
    margin-top: -25px;
">от {/literal}{$item.price/$item.rent_index*$curs_evro_smarty|round}{literal}<br>грн./мес
                </div>
                {/literal} {/if}
                {if $item.id_brand == '26' && $item.id_category != 60 && $login == 'old version'}<i
                        class="guarantee-icon"></i>{/if}
