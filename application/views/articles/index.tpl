{include file=_header.tpl}
  ...
  {if $id}
    ...
    <div class="like">
      <div class="like-item">
        {literal}
          <a href="https://twitter.com/share" class="twitter-share-button" data-url = 'https://590.ua/articles/{/literal}{$article.id}{literal}' data-via="590Ua" data-lang="ru">Твитнуть</a>
    ...
    {if $pages->pageCount > 1}
      <div class="pager-large">
        ...
        <div class="pager-large-pages">
          {if $pages->current > 1}
            <a class="btn btn-mini" href="{if $pages->current-1=='1'}/articles{else}/articles/page/{$pages->current-1}{/if}">Предыдущая</a>
          {/if}
