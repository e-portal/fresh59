<div class="container all-sale">
    ...
    <h1 class="liner cent wrap"><span>Акции интернет-магазина</span></h1>
                ...
                {if $pages->pageCount > 1}
                    <div class="blocks-pagination">
                        ...
                        {if $pages->pageCount && $pages->lastPageInRange != $pages->last}
                            <span>...</span>
                            <a href="/news{$firstPageUrl}/page/{$pages->pageCount}"
                               class="pagin-number">{$pages->pageCount}</a>
                        {/if}
