					...
					<div class="panel panel-primary">
						...
						<div id="collapse2" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<div class="radio">
									<label><input type="radio" name="opt_payment" value="1" checked="checked" />Наличными</label>
								</div>
<!-- 								<div class="radio">
									<label><input type="radio" name="opt_payment" value="2" />MasterCard / Visa</label>
								</div>
								<div class="radio">
									<label><input type="radio" name="opt_payment" value="3" />Кредит</label>
								</div>
 -->								<div id="credit" style="display:none">
									<div class="radio">
										<label><input type="radio" name="opt_credit_method"  checked="checked">ПриватБанк Оплата Частями</label>
									</div>
									<div class="radio">
										<label><input type="radio" name="opt_credit_method">ПриватБанк Мгновенная Расрочка</label>
									</div>
								</div>
								{literal}
								<script>
									window.onload = function() {
										$('input[name="opt_payment"]').change(function(e){
											if ($(this).val() == 3) {
												$("#credit").show();
											} else {
												$("#credit").hide();
								...
								<div class="radio">
									<label><input type="radio" name="opt_delivery" checked="checked">Курьер</label>
								</div>
<!-- 								<div class="radio">
									<label><input type="radio" name="opt_delivery">Новая Почта</label>
								</div>
 -->								<div class="radio">
									<label><input type="radio" name="opt_delivery">Самовывоз</label>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<aside class="aside-total">
				<div class="alert alert-info">
					...
					<div class="total">
						<div>
							<div class="total-title">{$basketStats.amount} товар на сумму</div>
							<div class="total-price">{$basketStats.summ} {$smarty.session.Currency.title}</div>
						</div>
						<br>
						<div>
						...
						<div class="total-info">
							...
							<div class="total-price"><strong>{$basketStats.summ} {$smarty.session.Currency.title}</strong></div>
						</div>
					</div>
					<div class="total-buy">
