...
<!-- navigation -->
<div class="b-navigation b-navigation-hidden">
    <div class="title"><span class="b-navigation-toggle">Каталог товаров</span></div>
    <ul id="navigation-menu" class="b-navigation-menu hidden">
