    ...
    function doBasket(obj) {/* add basket-section-prod*/
        ...
        for (prod_data in obj) {
            ...
            $('<div class="basket-section basket-section' + i + '">\n' +
                ...
                '                            <div class="prod-price-total" data-value="' + ((obj[prod_data].price > obj[prod_data].sale ? obj[prod_data].sale : obj[prod_data].price) * 1 + '">' + ((obj[prod_data].price > obj[prod_data].sale ? obj[prod_data].sale : obj[prod_data].price) * obj[prod_data].quantity) + '</div>\n' +
